...
PLAYZ_destroyVehiclesMoreDamaged=1;
...
PLAYZ_limitedClasses = ["UH1H_DZ", "AH6X_DZ", "Mi17_DZ", "AN2_DZ", "MH6J_DZ", "HMMWV_DZ", "SUV_DZ"];
PLAYZ_classLimits    = [3        , 2        , 3        , 5       , 1        , 3         , 3 ];
...
PLAYZ_staticSpawnFullyRepaired=true;
