...
_EXECgenTools = 'player execVM "' + EAT_directory + '\tools\%1"';
...
[
["",true],
	["Add Humanity to self or target", [],"", -5, [["expression", '["add"] execVM "' + EAT_directory + '\tools\humanityChanger.sqf"']], "1", "1"],
	["Remove Humanity from self or target", [],"", -5, [["expression", '["remove"] execVM "' + EAT_directory + '\tools\humanityChanger.sqf"']], "1", "1"],
		["", [], "", -5, [["expression", ""]], "1", "0"],
		["Main Menu", [20], "#USER:epochmenustart", -5, [["expression", ""]], "1", "1"]
];
...
[
["",true],
//	Example: ["Name",[],"", -5, [["expression", '[x,y,z] execVM "' + EAT_directory + '\tools\Teleport\teleportToLocation.sqf"']], "1", "1"],
...
//	["Teleport To Starry",[],"", -5, [["expression", '[6325.6772,7807.7412,0] execVM "' + EAT_directory + '\tools\Teleport\teleportToLocation.sqf"']], "1", "1"],
		["", [], "", -5, [["expression", ""]], "1", "0"],
		["Main Menu", [20], "#USER:epochmenustart", -5, [["expression", ""]], "1", "1"]
];
...
[
["",true],
	// Entry Format:["Entry Name",[],"",-5,[["expression",'["Skin_class_name"] execVM "' + EAT_directory + '\tools\skinChanger.sqf"']],"1","1"],
...
CrateMenuPrivate=[
	...
	["DayZ Base Building",[],"",-5,[["expression",format[_EXECcrates,"local","dayzbasebuilding.sqf"]]],"1","1"],
	["DayZ Medicine and Food",[],"",-5,[["expression",format[_EXECcrates,"local","dayzmedandfood.sqf"]]],"1","1"],
...
CrateMenuPublic=[
	...
	["DayZ Base Building",[],"",-5,[["expression",format[_EXECcrates,"global","dayzbasebuilding.sqf"]]],"1","1"],
	["DayZ Medicine and Food",[],"",-5,[["expression",format[_EXECcrates,"global","dayzmedandfood.sqf"]]],"1","1"],
