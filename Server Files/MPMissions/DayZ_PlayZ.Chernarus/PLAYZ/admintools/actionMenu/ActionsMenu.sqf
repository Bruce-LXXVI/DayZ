...
_pathtoscripts = format["%1\actionMenu\", EAT_directory];
_EXECscript1 = 'player execVM "'+_pathtoscripts+'%1"';
_EXECscript2 = '["%1"] execVM "' + EAT_directory + '\actionMenu\FunMenu\morph.sqf"';
_EXECscript3 = '["%1"] execVM "' + EAT_directory + '\actionMenu\FunMenu\movements.sqf"';
_EXECscript4 = '[%1] execVM "' + EAT_directory + '\actionMenu\contactAdmin.sqf"';
