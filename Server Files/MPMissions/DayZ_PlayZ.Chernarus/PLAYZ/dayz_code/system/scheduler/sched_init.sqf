...
call compile preprocessFileLineNumbers ("PLAYZ\dayz_code\system\scheduler\sched_towngenerator.sqf");
...
call compile preprocessFileLineNumbers ("PLAYZ\dayz_code\system\scheduler\sched_buriedZeds.sqf");
...
call compile preprocessFileLineNumbers ("PLAYZ\dayz_code\system\scheduler\sched_spawnCheck.sqf");
