...
server_publishObj = compile preprocessFileLineNumbers "\z\addons\dayz_server\PLAYZ\compile\server_publishObject.sqf";	//Creates the object in DB
...
server_hiveReadWrite = {
	...
	//diag_log str formatText["READ/WRITE: %1",_data];
