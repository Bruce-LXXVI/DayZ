	...
	_axeBusWPradius = 4;//waypoint radius
	...
	_axeBusRouteWaypoints = [
		[1,		[13100.035,	10353.128,	_axWPZ]], // 0
		[1,		[12978.129,	8359.0088,	_axWPZ]], // 1
		[1,		[13287.419,	6961.9658,	_axWPZ]],
		[1,		[13458.568,	6253.623,	_axWPZ]],
		[1,		[13381.949,	5448.3105,	_axWPZ]],
		[1,		[12033.441,	3489.1321,	_axWPZ]],
		[1,		[10881.695,	2753.395,	_axWPZ]],
		[1,		[10500.636,	2327.4365,	_axWPZ]],
		[1,		[10044.312,	2080.583,	_axWPZ]],
		[1,		[7967.4771,	3178.3748,	_axWPZ]],
		[1,		[7309.5215,	2730.1248,	_axWPZ]],
		[1,		[7035.7368,	2495.2661,	_axWPZ]],
		[1,		[6575.8452,	2881.9497,	_axWPZ]],
		[1,		[6405.46,	2682.3545,	_axWPZ]],
		[1,		[4542.2134,	2442.2568,	_axWPZ]],
		[1,		[3567.1011,	2452.0801,	_axWPZ]],
		[1,		[1833.5068,	2222.8921,	_axWPZ]],
		[1,		[1092.8208,	2362.468,	_axWPZ]],
		[1,		[1848.2321,	2223.7651,	_axWPZ]],
		[1,		[3555.5591,	2441.7156,	_axWPZ]],
		[1,		[4547.3013,	2434.5591,	_axWPZ]],
		[1,		[6335.6421,	2406.5798,	_axWPZ]],
		[1,		[6856.6782,	2354.676,	_axWPZ]],
		[1,		[7959.4185,	3173.9136,	_axWPZ]],
		[1,		[9980.9307,	2057.4424,	_axWPZ]],
		[1,		[10513.25,	2334.8142,	_axWPZ]],
		[1,		[10883.257,	2738.457,	_axWPZ]],
		[1,		[12028.229,	3482.8652,	_axWPZ]],
		[1,		[13386.496,	5402.1387,	_axWPZ]],
		[1,		[13465.364,	6263.1367,	_axWPZ]],
		[1,		[13272.938,	7002.8833,	_axWPZ]],
		[1,		[12977.121,	8378.8184,	_axWPZ]],
		[1,		[12279.391,	8968.3184,	_axWPZ]],
		[1,		[12008.05,	9180.4473,	_axWPZ]],
		[1,		[12269.771,	9496.8311,	_axWPZ]],
		[1,		[12974.933,	10222.065,	_axWPZ]]
	];
	...
	{
		_newVeh = createVehicle ["Sign_sphere10cm_EP1", _x select 1, [], 0, "NONE"];
		if( (_x select 0) > 0) then {
			_newVeh setVariable ["ObjectUID", _forEachIndex, true];
		} else {
	...
	//Create Bus
	_dir = 244;
	_axeBus = _axeBusVehicleType createVehicle _axeBuspawnpos;
	_axeBus setDir _dir;
	_axeBus setPos getPos _axeBus;
	_axeBus setVariable ["ObjectUID", [_dir,getPos _axeBus] call dayz_objectUID2, true];
	_axeBus setFuel .3;
	_axeBus allowDamage false;
	...
	//[_axeBus, "all"] spawn server_updateObject;
	...
	for [{ x=1 },{ x <3 },{ x = x + 1; }] do {
		...
		if(x > 1) then {
			...
			_axeBus addEventHandler ["killed", {[false] execVM "\z\addons\dayz_server\PLAYZ\busroute\Chernarus\init_bus.sqf"}];//Shouldn't be required
	...
	//diag_log format ["AXLOG:BUS: Tick:%1",time];
		...
		_arrJunk = ["Fort_Barricade","RoadBarrier_long","Land_Misc_Garb_Heap_EP1","Land_fort_bagfence_long","Fort_RazorWire","Grave","Hedgehog","Rubbish1","Rubbish2","Rubbish3","Rubbish4","Rubbish5","Land_Misc_Rubble_EP1","UralWreck","SKODAWreck","HMMWVWreck","datsun02Wreck","hiluxWreck","UAZWreck","datsun01Wreck","Land_Misc_Garb_Heap_EP1","Land_CacBlock_Stripes","Land_CacBlock_D"];
		//Remove Junk
